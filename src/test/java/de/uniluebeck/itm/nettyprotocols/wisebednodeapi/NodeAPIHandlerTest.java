package de.uniluebeck.itm.nettyprotocols.wisebednodeapi;
...
import de.uniluebeck.itm.nettyprotocols.wisebednodeapi.packet.TimeOutResponse;
import de.uniluebeck.itm.nettyprotocols.wisebednodeapi.packet.interaction.*;
...
public class NodeAPIHandlerTest {
	...
	private Request createAndReturnRequestAndSetupMessageEvent(Class requestClass, MessageEvent messageEvent) {
		...
		Mockito.when(messageEvent.getRemoteAddress()).thenReturn(remoteAddress);
		Mockito.when(messageEvent.getFuture()).thenReturn(future);

		if (messageEvent instanceof DownstreamMessageEvent) {
			Mockito.when(downstreamMessageEvent.getMessage()).thenReturn(request);
			Mockito.doNothing().when(channelHandlerContext).sendDownstream(Matchers.<DownstreamMessageEvent>any());

		} else {
			Mockito.when(upstreamMessageEvent.getMessage()).thenReturn(commandResponse);
			Mockito.doNothing().when(channelHandlerContext).sendUpstream(Matchers.<UpstreamMessageEvent>any());
			...
			Mockito.when(requestCache.get(requestID)).thenReturn(requestCacheEntry);
		}
		return request;
	}
	...
	private Object setupActAndVerifyDownstreamMessageEvent(Class requestClass) throws Exception {
		...
		// verify
		Mockito.verify(channelHandlerContext).sendDownstream(argumentCaptor.capture());
	...
	public void ifSetVirtualLinkRequestReceivedDownstreamSetVirtualLinkCommandIsSentDownstream() throws Exception {
		...
		assertEquals(CommandType.LinkControl.SET_VIRTUAL_LINK,
				((SetVirtualLinkCommand) message).getCommandType()
		);
	...
	public void ifDestroyVirtualLinkRequestReceivedDownstreamDestroyVirtualLinkCommandIsSentDownstream() throws Exception {
		...
		assertEquals(CommandType.LinkControl.DESTROY_VIRTUAL_LINK,
				((DestroyVirtualLinkCommand) message).getCommandType()
		);
	...
	public void ifEnablePhysicalLinkRequestReceivedDownstreamEnablePhysicalLinkCommandIsSentDownstream() throws Exception {
		...
		assertEquals(CommandType.LinkControl.ENABLE_PHYSICAL_LINK,
				((EnablePhysicalLinkCommand) message).getCommandType()
		);
	...
	public void ifDisablePhysicalLinkRequestReceivedDownstreamDisablePhysicalLinkCommandIsSentDownstream() throws Exception {
		...
		assertEquals(CommandType.LinkControl.DISABLE_PHYSICAL_LINK,
				((DisablePhysicalLinkCommand) message).getCommandType()
		);
	...
	public void ifSetStartTimeRequestReceivedDownstreamSetStartTimeCommandIsSentDownstream() throws Exception {
		...
		Assert.assertEquals(requestID, ((SetStartTimeCommand) message).getRequestID());
		...
		Assert.assertEquals(ChannelBuffers.wrappedBuffer(payload), ((SetStartTimeCommand) message).getPayload());
	}
	...
	public void ifGetPropertyValueRequestReceivedDownstreamGetPropertyValueCommandIsSentDownstream() throws Exception {
		...
		assertEquals(CommandType.NetworkDescription.GET_PROPERTY_VALUE,
				((GetPropertyValueCommand) message).getCommandType()
		);
	...
	public void ifGetNeighborhoodRequestReceivedDownstreamGetNeighborhoodCommandIsSentDownstream() throws Exception {
		...
		assertEquals(CommandType.NetworkDescription.GET_NEIGHBORHOOD,
				((GetNeighborhoodCommand) message).getCommandType()
		);
	...
	public void ifTextDataRequestReceivedDownstreamTextDataCommandIsSentDownstream() throws Exception {
		...
		Assert.assertEquals(requestID, ((TextDataCommand) message).getRequestID());
		...
		Assert.assertEquals(ChannelBuffers.wrappedBuffer(payload), ((TextDataCommand) message).getPayload());
	}
	...
	public void ifVirtualLinkDataRequestReceivedDownstreamVirtualLinkDataCommandIsSentDownstream() throws Exception {
		...
		assertEquals(CommandType.Interaction.VIRTUAL_LINK_DATA,
				((VirtualLinkDataCommand) message).getCommandType()
		);
	...
	public void ifFlashProgramDataRequestReceivedDownstreamFlashProgramDataCommandIsSentDownstream() throws Exception {
		...
		assertEquals(CommandType.Interaction.FLASH_PROGRAM_DATA,
				((FlashProgramDataCommand) message).getCommandType()
		);
	...
	public void ifNodeOutputTextRequestReceivedDownstreamNodeOutputTextCommandIsSentDownstream() throws Exception {
		...
		assertEquals(CommandType.Interaction.NODE_OUTPUT_TEXT,
				((NodeOutputTextCommand) message).getCommandType()
		);
	...
	public void ifNodeOutputBinaryRequestReceivedDownstreamNodeOutputBinaryCommandIsSentDownstream() throws Exception {
		...
		assertEquals(CommandType.Interaction.NODE_OUTPUT_BINARY,
				((NodeOutputBinaryCommand) message).getCommandType()
		);
	...
	public void ifNodeOutputVirtualLinkRequestReceivedDownstreamNodeOutputVirtualLinkCommandIsSentDownstream() throws Exception {
		...
		assertEquals(CommandType.Interaction.NODE_OUTPUT_VIRTUAL_LINK,
				((NodeOutputVirtualLinkCommand) message).getCommandType()
		);
		...
		assertEquals(ChannelBuffers.wrappedBuffer(payload),
				((NodeOutputVirtualLinkCommand) message).getPayload()
		);
	}
	...
	private Object setupActAndVerifyUpstreamMessageEventForRequest() throws Exception {
		...
		//verify
		Mockito.verify(requestCache).get(requestID);
		Mockito.verify(channelHandlerContext).sendUpstream(argumentCaptor.capture());
	...
	public void ifExpectedSetVirtualIdCommandResponseReceivedUpstreamSetVirtualIdResponseIsSentUpstream() throws Exception {
		...
		assertEquals(virtualNodeId,
				((SetVirtualIDRequest) ((SetVirtualIDResponse) message).getRequest()).getVirtualNodeId()
		);
	}
	...
	public void ifExpectedGetPropertyValueCommandResponseReceivedUpstreamGetPropertyValueResponseIsSentUpstream() throws Exception {
		...
		assertEquals(property,
				((GetPropertyValueRequest) ((GetPropertyValueResponse) message).getRequest()).getProperty()
		);
	}
	...
	public void ifExpectedTextDataCommandResponseReceivedUpstreamTextDataResponseIsSentUpstream() throws Exception {
		...
		assertEquals(messageLevel,
				((TextDataRequest) ((TextDataResponse) message).getRequest()).getMessageLevel()
		);
	}
	...
	public void ifExpectedVirtualLinkDataCommandResponseReceivedUpstreamVirtualLinkDataResponseIsSentUpstream() throws Exception {
		...
		assertEquals(destinationNode,
				((VirtualLinkDataRequest) ((VirtualLinkDataResponse) message).getRequest()).getDest()
		);
		assertEquals(sourceNode,
				((VirtualLinkDataRequest) ((VirtualLinkDataResponse) message).getRequest()).getSource()
		);
	}
	...
	public void ifExpectedNodeOutputTextCommandResponseReceivedUpstreamNodeOutputTextResponseIsSentUpstream() throws Exception {
		...
		assertEquals(messageLevel,
				((NodeOutputTextRequest) ((NodeOutputTextResponse) message).getRequest()).getMessageLevel()
		);
	}
	...
	public void ifExpectedNodeOutputVirtualLinkCommandResponseReceivedUpstreamNodeOutputVirtualLinkResponseIsSentUpstream() throws Exception {
		...
		assertEquals(rssi,
				((NodeOutputVirtualLinkRequest) ((NodeOutputVirtualLinkResponse) message).getRequest()).getRssi()
		);
		assertEquals(lqi,
				((NodeOutputVirtualLinkRequest) ((NodeOutputVirtualLinkResponse) message).getRequest()).getLqi()
		);
		assertEquals(len,
				((NodeOutputVirtualLinkRequest) ((NodeOutputVirtualLinkResponse) message).getRequest()).getLen()
		);
		assertEquals(destinationNode,
				((NodeOutputVirtualLinkRequest) ((NodeOutputVirtualLinkResponse) message).getRequest()).getDest()
		);
		assertEquals(sourceNode,
				((NodeOutputVirtualLinkRequest) ((NodeOutputVirtualLinkResponse) message).getRequest()).getSource()
		);
	}
	...
	public void testTimeOutOccurrenceForSetVirtualLinkResponseSentUpstream() throws Exception {
		...
		assertEquals(destinationNode,
				((SetVirtualLinkRequest) ((TimeOutResponse) message).getRequest()).getDestinationNode()
		);
	}
	...
	public void testTimeOutOccurrenceForDestroyVirtualLinkResponseSentUpstream() throws Exception {
		...
		assertEquals(destinationNode,
				((DestroyVirtualLinkRequest) ((TimeOutResponse) message).getRequest()).getDestinationNode()
		);
	}
	...
	public void testTimeOutOccurrenceForSetVirtualIdResponseSentUpstream() throws Exception {
		...
		assertEquals(virtualNodeId,
				((SetVirtualIDRequest) ((TimeOutResponse) message).getRequest()).getVirtualNodeId()
		);
	}
	...
	public void testTimeOutOccurrenceForGetPropertyValueResponseSentUpstream() throws Exception {
		...
		assertEquals(property,
				((GetPropertyValueRequest) ((TimeOutResponse) message).getRequest()).getProperty()
		);
	}
	...
	public void testTimeOutOccurrenceForTextDataResponseSentUpstream() throws Exception {
		...
		assertEquals(messageLevel,
				((TextDataRequest) ((TimeOutResponse) message).getRequest()).getMessageLevel()
		);
	}
	...
	public void testTimeOutOccurrenceForVirtualLinkDataResponseSentUpstream() throws Exception {
		...
		assertEquals(destinationNode,
				((VirtualLinkDataRequest) ((TimeOutResponse) message).getRequest()).getDest()
		);
	...
	public void testTimeOutOccurrenceForNodeOutputTextResponseSentUpstream() throws Exception {
		...
		assertEquals(messageLevel,
				((NodeOutputTextRequest) ((TimeOutResponse) message).getRequest()).getMessageLevel()
		);
	}
	...
	public void testTimeOutOccurrenceForNodeOutputVirtualLinkResponseSentUpstream() throws Exception {
		...
		assertEquals(destinationNode,
				((NodeOutputVirtualLinkRequest) ((TimeOutResponse) message).getRequest()).getDest()
		);
		assertEquals(sourceNode,
				((NodeOutputVirtualLinkRequest) ((TimeOutResponse) message).getRequest()).getSource()
		);
	}

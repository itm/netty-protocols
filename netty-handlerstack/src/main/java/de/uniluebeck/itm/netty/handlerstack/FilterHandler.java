...
//        log.debug("writeRequested " + e.getMessage().toString());
...
//        log.debug("receiveDownstreamOutput " + message.toString());
        checkState(ctx != null);
    ...
    public void receiveUpstreamOutput(final ChannelEvent message) {
        checkState(ctx != null);
        HandlerTools.sendUpstream(message, ctx);
    }
